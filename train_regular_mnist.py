...
def main():
    ...
    train_dataset = datasets.MNIST('datas/MNIST', train=True, download=True, transform=transform)
    test_dataset = datasets.MNIST('datas/MNIST', train=False, download=True, transform=transform)
